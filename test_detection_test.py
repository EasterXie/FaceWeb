...
def main():
    ...
    path_name = "F:/app_project/web_face_identification/face_identification/face_project/data/2021302021175"
    top_num = 50
    sign = "frontalface"
    ...
    webrtc_ctx = webrtc_streamer(
        ...
        rtc_configuration={"iceServers": [{"urls": ["stun:stun.ekiga.net:3478"]}]},
